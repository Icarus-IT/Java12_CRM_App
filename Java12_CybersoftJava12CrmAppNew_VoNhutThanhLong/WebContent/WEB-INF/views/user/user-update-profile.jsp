		...
		<div class="card card-form">
            <div class="row no-gutters">
                ...
                <div class="col-lg-8 card-form__body card-body">
                    <form action="<c:url value="<%=UrlConst.USER_UPDATE_PROFILE %>" />" method="post">
                        <div class="form-group">
                            <label for="email">Email:</label>
                            <input type="email" class="form-control" disabled="disabled" name="email" id="email" value="${sessionScope.UserInfo.email }">
                        </div>
                        <div class="form-group">
							<label for="password">Password:</label> <input type="text"
								value="${sessionScope.UserInfo.password}" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="phone" id="phone"  value="${sessionScope.UserInfo.phone }">
                        </div>
