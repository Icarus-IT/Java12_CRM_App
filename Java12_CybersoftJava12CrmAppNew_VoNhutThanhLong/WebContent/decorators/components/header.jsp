                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div id="account_menu" class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-item-text dropdown-item-text--lh">
                                <div><strong>${sessionScope.UserInfo.name }</strong></div>
                                <div>${sessionScope.UserInfo.email }</div>
                            </div>
                            ...
                            <a class="dropdown-item" href="<c:url value="<%=UrlConst.USER_UPDATE_PROFILE %>" />">
                                Edit account
                            </a>
                            <div class="dropdown-divider"></div>
