...
public class JspConst {
	...
	public static final String TASK_USER_DASHBOARD = "/WEB-INF/views/task/task-user-dashboard.jsp";
	...
	public static final String TASK_USER_UPDATE = "/WEB-INF/views/task/task-user-update.jsp";
	...
	public static final String USER_UPDATE_PROFILE = "/WEB-INF/views/user/user-update-profile.jsp";
}